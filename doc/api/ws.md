...
接口应在服务器端调用，不可在前端（小程序、网页、APP 等）直接调用，具体可参考接口调用指南
...
appid string 是 账号的唯一凭证，即 AppID，点此查看如何获取 Appid
secret string 是 唯一凭证密钥，即 AppSecret，点此查看如何获取 AppSecret
...
4. 注意事项
   ...
   AppSecret 是账号使用后台 API 接口的密钥，请开发者妥善保管，避免因泄露造成账号被其它人冒用等风险。
   ...
   关于如何获取 Appid 和 AppSecret 信息，以及如何冻结/解冻 AppSecret，请参考 此文档
...
40243 AppSecret 已被冻结，请解冻后再次调用。 点此查看如何解冻 AppSecret
...
7. 适用范围
   本接口在不同账号类型下的可调用情况：
   小程序 公众号 服务号 小游戏 微信小店 联盟带货机构 带货助手 移动应用 网站应用 视频号助手 多端应用
   ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔
   ✔：该账号可调用此接口
